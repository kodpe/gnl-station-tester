...
echo
echo "\033[34m_________________________DIFF TEST & VALGRIND_1______________________\033[0m"
# ---------- TEST 1 ----------
...
echo "\033[34m_________________________DIFF TEST & VALGRIND_2______________________\033[0m"
# ---------- TEST 1 ----------
...
echo
# ---------- TEST 3 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_3} 1> ${path_out_42000}${out_3} 2> ${path_out_42000}log3
...
echo
# ---------- TEST 4 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_4} 1> ${path_out_42000}${out_4} 2> ${path_out_42000}log4
...
echo
# ---------- TEST 5 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_5} 1> ${path_out_42000}${out_5} 2> ${path_out_42000}log5
...
echo
# ---------- TEST 6 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_6} 1> ${path_out_42000}${out_6} 2> ${path_out_42000}log6
...
echo
# ---------- TEST 7 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_7} 1> ${path_out_42000}${out_7} 2> ${path_out_42000}log7
...
echo
# ---------- TEST 8 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_8} 1> ${path_out_42000}${out_8} 2> ${path_out_42000}log8
...
echo
# ---------- TEST 9 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_9} 1> ${path_out_42000}${out_9} 2> ${path_out_42000}log9
...
echo
# ---------- TEST 10 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_10} 1> ${path_out_42000}${out_10} 2> ${path_out_42000}log10
...
echo
# ---------- TEST 11 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_11} 1> ${path_out_42000}${out_11} 2> ${path_out_42000}log11
...
echo
# ---------- TEST 12 ----------
valgrind ${VFLAGS} ./${NAME} ${path_test}${test_12} 1> ${path_out_42000}${out_12} 2> ${path_out_42000}log12
